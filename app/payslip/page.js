        ...
        <div id="payslip-preview" className="card" style={{ maxWidth: 860, margin: '0 auto' }}>
          <div className="card-body" style={{ padding: 0 }}>
            ...
            <div style={{ padding: '16px 32px', borderBottom: '1px solid var(--border-light)', display: 'flex', gap: 32, fontSize: 13, flexWrap: 'wrap' }}>
              ...
              <div><span style={{ color: 'var(--text-tertiary)' }}>Paid Days: </span><strong>{payslip.attendance.paidDays}</strong></div>
              <div><span style={{ color: 'var(--text-tertiary)' }}>LWP: </span><strong style={{ color: payslip.attendance.lwp > 0 ? 'var(--danger)' : 'inherit' }}>{payslip.attendance.lwp}</strong></div>
